...
bot.command('retention', ctx => {
  ctx.replyWithHTML("Question: What is the Retention Plan? How do I participate?\n\nAnswer: You can read the details of the first milestone of the retention plan here: https://prcycoin.com/wp-content/uploads/2021/01/PRCY-Milestone-Retention-Plan.pdf");
  ctx.deleteMessage();
});
